...
(custom-set-variables
 ...
 '(package-selected-packages
   '(async evil-collection google-translate all-the-icons ednc elfeed-org elfeed-tube elfeed-tube-mpv embark-consult emmet-mode evil-leader fd-dired git-auto-commit-mode hydra iedit mpv ob-async openwith rg s shrink-path undo-tree vertico wgrep which-key yaml-mode))
